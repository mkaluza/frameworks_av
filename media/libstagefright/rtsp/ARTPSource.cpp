...
void ARTPSource::addReceiverReport(const sp<ABuffer> &buffer) {
    ...
    uint32_t intervalExpected = expected - mPrevExpected;
    uint32_t intervalReceived = mNumBuffersReceived - mPrevNumBuffersReceived;
    int32_t intervalPacketLost = intervalExpected - intervalReceived;
